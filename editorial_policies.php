        ...
        <div class="bottom-menu">
            <div class="container">
				...
				<ul class="main-menu" id="main-menu">
                    ...
                    <li class="drop-down active"><a href="#!">Guidelines & Policies<i class="ion-chevron-down"></i></a>
			...
			<div class="row">
				...
				<div class="col-md-12 col-lg-12">
					...
					<div class="ptb-0">
						...
						<a class="mt-10 color-ash" href="#"><i class="mlr-10 ion-chevron-right"></i><b>Guidelines & Policies</b></a>
						<a class="mt-10 color-ash" href="#"><i class="mlr-10 ion-chevron-right"></i><b>Editorial Policies</b></a>
					</div>
					
					<div class="p-30 mtb-30 card-view">
						<img src="assets/images/Editorial-Policies.jpg" style="" alt="">
