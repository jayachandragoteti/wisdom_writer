        ...
        <div class="bottom-menu">
            <div class="container">
				...
				<ul class="main-menu" id="main-menu">
                    ...
                    <li class="drop-down active"><a href="#!">Online Submission<i class="ion-chevron-down"></i></a>
                        <ul class="drop-down-menu drop-down-inner">
            ...
            <div class="row">
                <div class="col-md-12 col-lg-8"><br>
                    <div class="ptb-0">
						...
						<a class="mt-10" href="#"><i class="mlr-10 ion-chevron-right"></i><b>Online Submission</b></a>
						<a class="mt-10" href="#"><i class="mlr-10 ion-chevron-right"></i><b>Registration</b></a>
					</div><br>
                    <form action="registration_php.php" method="post" enctype="multipart/form-data">
